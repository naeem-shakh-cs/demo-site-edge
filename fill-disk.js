  ...
  try {
    ...
    while (currentSize < targetSizeBytes) {
      try {
        ...
        console.log(`CPU Consumption (Chunk): User ${(cpuDelta.user / 1000).toFixed(2)}ms, System ${(cpuDelta.system / 1000).toFixed(2)}ms`);
        console.log(`Total CPU Usage: User ${(currentCpuUsage.user / 1000).toFixed(2)}ms, System ${(currentCpuUsage.system / 1000).toFixed(2)}ms`);
